              ...
              {!resumeFile && !formData.resume_url ? (
                <div className="space-y-2">
                  <Button
                    ...
                    disabled={!resumeFile && !!formData.resume_url}
                    className="w-full h-12 bg-slate-50 hover:bg-slate-100 border-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:border-slate-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <a
                        ...
                        className="text-xs text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 hover:underline break-all"
                      >
                        {formData.resume_url}
                      </a>
                    </div>
