                ...
                (() => {
                  ...
                  return (
                    <Button
                      ...
                      disabled={
                        schedulingCalls || checkingScheduled || allScheduled
                      }
                ...
                {filteredJobs.map((job) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <Briefcase className="h-5 w-5 text-primary shrink-0 ml-2 opacity-60 group-hover:opacity-100 transition-opacity" />
                    </div>
