...
export default function Sidebar({
  ...
  const SidebarContent = () => (
    <div className="flex h-screen w-52 flex-col border-r border-slate-200/50 dark:border-slate-800/50 bg-gradient-to-b from-slate-50/95 to-white dark:from-slate-900/95 dark:to-slate-950 backdrop-blur-sm">
      {/* Logo/Brand */}
      ...
      <div className="border-b border-slate-200/50 dark:border-slate-800/50 p-3">
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <div className="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-cyan-400 to-blue-500">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-slate-600 dark:text-slate-400 capitalize truncate">
              {user.role}
            </p>
          </div>
        </div>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.path}
                className={cn(
                  "group relative flex items-center gap-2 rounded-lg px-3 py-2.5 text-xs font-medium transition-all duration-200",
                  isActive
